  ...
  context "image handling" do
    context "image_properties" do
      it "should get image properties" do
        ...
        image = Sprite::ImageReader.read(source)
    ...
    context "composite_images" do
      it "should composite two images into one horizontally" do
        source1 = Sprite::Source.new(@image_paths[:good])
        image1 = Sprite::ImageReader.read(source1)
        source2 = Sprite::Source.new(@image_paths[:mid])
        image2 = Sprite::ImageReader.read(source2)
